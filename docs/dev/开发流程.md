...
从 [公共资源仓库](https://github.com/l429609201/Misaka-Scraper-Resources) 的 `src/` 目录根据你测试平台的架构，选择性的下载两个 `.so` 文件，放到项目的 `src/` 目录下：
...
::: tip 提示
如果您不确定如何开始，可以先查看 [Issues](https://github.com/l429609201/misaka_danmu_server/issues) 中的问题。
:::
