        ...
        nav: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {text: 'bili源地区限制解除', link: '/advanced/bili源地区限制解除'},
                ]
            },
            {
                text: '运维优化',
        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        text: 'bili源地区限制解除',
                        link: '/advanced/bili源地区限制解除',
                        collapsed: true,
                        items: [
                            {text: '功能说明', link: '/advanced/bili源地区限制解除#🎯-功能说明'},
                            {text: '配置方法', link: '/advanced/bili源地区限制解除#🔧-配置方法'},
                            {text: '解析服务器获取', link: '/advanced/bili源地区限制解除#🏗️-解析服务器获取'},
                            {text: '使用说明', link: '/advanced/bili源地区限制解除#🔍-使用说明'},
                            {text: '故障排除', link: '/advanced/bili源地区限制解除#🛠️-故障排除'},
                            {text: '高级配置', link: '/advanced/bili源地区限制解除#💡-高级配置'},
                        ]
                    },
                ]
            },
